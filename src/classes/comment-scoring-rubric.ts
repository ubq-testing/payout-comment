...
import { ContributorClassesKeys } from "../types/contributor-style";
...
export class CommentScoring {
  ...
  private _calculateWordScores(words: string[]): (typeof CommentScoring.prototype.commentScores)[number]["details"][number]["wordScoreCommentDetails"] {
